                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 my-4">
                            <button type="button" v-on:click="search()" id="submit-button" class="btn btn-warning mx-1"><i class="fa fa-search"></i></button>
                            <button type="button" v-on:click="cancelSearch()" class="btn btn-danger mx-1"><i class="fa fa-times"></i></button>
                            <button type="button" v-if="isSearch" class="btn btn-danger" onclick="ExportToExcel('xlsx')"><i class="fas fa-file-export px-1"></i> Export </button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    function ExportToExcel(type, fn, dl) {
       ...
       return dl ?
         ...
         XLSX.writeFile(wb, fn || ('dailyReport.' + (type || 'xlsx')));
    }
</script>
